...
public abstract class ObjectScreen3d implements Screen, InputProcessor {
	...
	public ObjectScreen3d(final Kite game) {
		this.game = game;
		Gdx.input.setCatchBackKey(true);
	}

	public ObjectScreen3d(final Kite game, GO obj) {
		this(game);
		this.object = obj;
	}
